...
impl<'a> Matcher<'a> {
    ...
    pub fn new(text: &'a str) -> Option<Matcher<'a>> {
    ...
    pub fn match_string<'b>(&mut self, string: &'b str) -> Vec<(&MatcherToken<'a>, &'b str)> {
